...
const Node = ({ id, x, y, ports, labels, height, width, properties, className, rx = 2, ry = 2, offsetX = 0, offsetY = 0, icon, disabled, style, children, nodes, edges, childEdge = React.createElement(Edge, null), childNode = React.createElement(Node, null), remove = React.createElement(Remove, null), port = React.createElement(Port, null), label = React.createElement(Label, null), isDraggable = false, onRemove = () => undefined, onDrag = () => undefined, onDragStart = () => undefined, onDragEnd = () => undefined, onClick = () => undefined, onKeyDown = () => undefined, onEnter = () => undefined, onLeave = () => undefined }) => {
    ...
    return isDraggable ? (React.createElement(motion.g, { initial: {
            cursor: 'initial',
            opacity: 0,
            translateX: x,
            translateY: y
        ...
        React.createElement("g", null,
            ...
            (nodes === null || nodes === void 0 ? void 0 : nodes.length) > 0 && nodes.map(renderNode)))) : (React.createElement(motion.g, { initial: {
            cursor: 'initial',
            opacity: 0,
            translateX: x,
            translateY: y
